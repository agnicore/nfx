...
nfx
{
  ...
  {
    resolution-ms=150
    event{ name='A' interval='0:0:1' Context='ItonTV' handler{type='NFX.ITest.Time.TeztHandler, NFX.ITest' arg0='Gorin' arg1='true'} }
    event{ name='B' interval='0:0:3' Context='Nativ'  handler{type='NFX.ITest.Time.TeztHandler, NFX.ITest' arg0='Kedmi' arg1='false'} }
  }
}";
