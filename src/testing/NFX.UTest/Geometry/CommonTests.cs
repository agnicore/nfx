...
namespace NFX.UTest.Geometry
{
  ...
  public class CommonTests
  {
    ...
    {
      Aver.AreEqual(157D, Math.Floor(CartesianUtils.MapDirectionToAngle(NFX.Geometry.MapDirection.North) * 100D));
      Aver.AreEqual(314D + 157D, Math.Floor(CartesianUtils.MapDirectionToAngle(NFX.Geometry.MapDirection.South) * 100D));
      Aver.AreEqual(0D, Math.Floor(CartesianUtils.MapDirectionToAngle(NFX.Geometry.MapDirection.East) * 100D));
      Aver.AreEqual(314D, Math.Floor(CartesianUtils.MapDirectionToAngle(NFX.Geometry.MapDirection.West) * 100D));

      Aver.AreEqual(157D - 79D, Math.Floor(CartesianUtils.MapDirectionToAngle(NFX.Geometry.MapDirection.NorthEast) * 100D));
      Aver.AreEqual(157D + 78D, Math.Floor(CartesianUtils.MapDirectionToAngle(NFX.Geometry.MapDirection.NorthWest) * 100D));

      Aver.AreEqual(314D + 157D + 78D, Math.Floor(CartesianUtils.MapDirectionToAngle(NFX.Geometry.MapDirection.SouthEast) * 100D));
      Aver.AreEqual(314D + 157D - 79D, Math.Floor(CartesianUtils.MapDirectionToAngle(NFX.Geometry.MapDirection.SouthWest) * 100D));
    }

    [Run]
    public void AngleToMapDirection()
    {
      Aver.IsTrue(NFX.Geometry.MapDirection.North ==
        CartesianUtils.AngleToMapDirection(CartesianUtils.MapDirectionToAngle(NFX.Geometry.MapDirection.North)));
      Aver.IsTrue(NFX.Geometry.MapDirection.South ==
        CartesianUtils.AngleToMapDirection(CartesianUtils.MapDirectionToAngle(NFX.Geometry.MapDirection.South)));
      Aver.IsTrue(NFX.Geometry.MapDirection.East ==
        CartesianUtils.AngleToMapDirection(CartesianUtils.MapDirectionToAngle(NFX.Geometry.MapDirection.East)));
      Aver.IsTrue(NFX.Geometry.MapDirection.West ==
        CartesianUtils.AngleToMapDirection(CartesianUtils.MapDirectionToAngle(NFX.Geometry.MapDirection.West)));

      Aver.IsTrue(NFX.Geometry.MapDirection.NorthEast ==
        CartesianUtils.AngleToMapDirection(CartesianUtils.MapDirectionToAngle(NFX.Geometry.MapDirection.NorthEast)));
      Aver.IsTrue(NFX.Geometry.MapDirection.NorthWest ==
        CartesianUtils.AngleToMapDirection(CartesianUtils.MapDirectionToAngle(NFX.Geometry.MapDirection.NorthWest)));

      Aver.IsTrue(NFX.Geometry.MapDirection.SouthEast ==
        CartesianUtils.AngleToMapDirection(CartesianUtils.MapDirectionToAngle(NFX.Geometry.MapDirection.SouthEast)));
      Aver.IsTrue(NFX.Geometry.MapDirection.SouthWest ==
