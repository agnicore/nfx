...
namespace NFX.UTest.Glue
{
  ...
  ///<summary>
  /// Client for glued contract NFX.UTest.Glue.ITestContractA server.
  /// Each contract method has synchronous and asynchronous versions, the later denoted by 'Async_' prefix.
  /// May inject client-level inspectors here like so:
  ///   client.MsgInspectors.Register( new YOUR_CLIENT_INSPECTOR_TYPE());
  ///</summary>
  public class TestContractAClient : ClientEndPoint, NFX.UTest.Glue.ITestContractA
  {
  ...
  #region Static Members
     ...
     {
         var t = typeof(NFX.UTest.Glue.ITestContractA);
  ...
  #region .ctor
     ...
     {
       get { return typeof(NFX.UTest.Glue.ITestContractA); }
     }
  ...
  #region Contract Methods
         ...
         ///<summary>
         /// Asynchronous invoker for  'NFX.UTest.Glue.ITestContractA.Method1'.
         /// This is a two-way call per contract specification, meaning - the server sends the result back either
