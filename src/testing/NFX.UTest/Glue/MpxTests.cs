...
namespace NFX.UTest.Glue
{
 ...
 nfx
 {
  ...
  glue
  {
     ...
     servers
     {
        server { name='test1' node='mpx://*:5701' contract-servers='NFX.UTest.Glue.TestServerA, NFX.UTest;NFX.UTest.Glue.TestServerB_ThreadSafe, NFX.UTest'}
        server { name='test2' node='mpx://*:5702' contract-servers='NFX.UTest.Glue.TestServerB_NotThreadSafe, NFX.UTest'}
     }
  }
 }
 "; 
