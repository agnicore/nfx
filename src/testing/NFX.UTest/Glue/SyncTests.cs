...
namespace NFX.UTest.Glue
{
 ...
 nfx
 {
  ...
  glue
  {
     ...
     servers
     {
        server { name='test1' node='sync://*:5432' contract-servers='NFX.UTest.Glue.TestServerA, NFX.UTest;NFX.UTest.Glue.TestServerB_ThreadSafe, NFX.UTest'}
        server { name='test2' node='sync://*:5433' contract-servers='NFX.UTest.Glue.TestServerB_NotThreadSafe, NFX.UTest'}
     }
  }
 }
 "; 
