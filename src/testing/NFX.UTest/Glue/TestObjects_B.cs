...
namespace NFX.UTest.Glue
{
 ...
 //=====================================================================================================================================================
  ///<summary>
  /// Client for glued contract NFX.UTest.Glue.ITestContractB server.
  /// Each contract method has synchronous and asynchronous versions, the later denoted by 'Async_' prefix.
  /// May inject client-level inspectors here like so:
  ///   client.MsgInspectors.Register( new YOUR_CLIENT_INSPECTOR_TYPE());
  ///</summary>
  public class TestContractBClient : ClientEndPoint, NFX.UTest.Glue.ITestContractB
  {
  ...
  #region Static Members
     ...
     {
         var t = typeof(NFX.UTest.Glue.ITestContractB);
         s_ts_CONTRACT = new TypeSpec(t);
         @s_ms_SetPersonOfTheDay_0 = new MethodSpec(t.GetMethod("SetPersonOfTheDay", new Type[]{ typeof(@NFX.@UTest.@Glue.@PersonData) }));
  ...
  #region .ctor
     ...
     {
       get { return typeof(NFX.UTest.Glue.ITestContractB); }
     }
  ...
  #region Contract Methods
         ...
         ///<summary>
         /// Synchronous invoker for  'NFX.UTest.Glue.ITestContractB.SetPersonOfTheDay'.
         /// This is a two-way call per contract specification, meaning - the server sends the result back either
         ///  returning no exception or WrappedExceptionData instance.
         /// ClientCallException is thrown if the call could not be placed in the outgoing queue.
         /// RemoteException is thrown if the server generated exception during method execution.
         ///</summary>
         public void @SetPersonOfTheDay(@NFX.@UTest.@Glue.@PersonData  @person)
         {
         ...
         ///<summary>
         /// Asynchronous invoker for  'NFX.UTest.Glue.ITestContractB.SetPersonOfTheDay'.
         /// This is a two-way call per contract specification, meaning - the server sends the result back either
         ///  returning no exception or WrappedExceptionData instance.
         /// CallSlot is returned that can be queried for CallStatus, ResponseMsg and result.
         ///</summary>
         public CallSlot Async_SetPersonOfTheDay(@NFX.@UTest.@Glue.@PersonData  @person)
         {
         ...
         ///<summary>
         /// Synchronous invoker for  'NFX.UTest.Glue.ITestContractB.GetPersonOfTheDay'.
         /// This is a two-way call per contract specification, meaning - the server sends the result back either
         ///  returning '@NFX.@UTest.@Glue.@PersonData' or WrappedExceptionData instance.
         /// ClientCallException is thrown if the call could not be placed in the outgoing queue.
         /// RemoteException is thrown if the server generated exception during method execution.
         ///</summary>
         public @NFX.@UTest.@Glue.@PersonData @GetPersonOfTheDay()
         {
            var call = Async_GetPersonOfTheDay();
            return call.GetValue<@NFX.@UTest.@Glue.@PersonData>();
         }

         ///<summary>
         /// Asynchronous invoker for  'NFX.UTest.Glue.ITestContractB.GetPersonOfTheDay'.
         /// This is a two-way call per contract specification, meaning - the server sends the result back either
         ///  returning no exception or WrappedExceptionData instance.
         /// CallSlot is returned that can be queried for CallStatus, ResponseMsg and result.
         ///</summary>
         ...
         ///<summary>
         /// Synchronous invoker for  'NFX.UTest.Glue.ITestContractB.GetName'.
         /// This is a two-way call per contract specification, meaning - the server sends the result back either
         ...
         ///<summary>
         /// Asynchronous invoker for  'NFX.UTest.Glue.ITestContractB.GetName'.
         /// This is a two-way call per contract specification, meaning - the server sends the result back either
         ///  returning no exception or WrappedExceptionData instance.
         /// CallSlot is returned that can be queried for CallStatus, ResponseMsg and result.
         ///</summary>
         ...
         ///<summary>
         /// Synchronous invoker for  'NFX.UTest.Glue.ITestContractB.GetPersonalData'.
         /// This is a two-way call per contract specification, meaning - the server sends the result back either
         ///  returning '@System.@Collections.@Generic.@List<@NFX.@UTest.@Glue.@PersonData>' or WrappedExceptionData instance.
         /// ClientCallException is thrown if the call could not be placed in the outgoing queue.
         /// RemoteException is thrown if the server generated exception during method execution.
         ///</summary>
         public @System.@Collections.@Generic.@List<@NFX.@UTest.@Glue.@PersonData> @GetPersonalData(@System.@Int32[]  @ids)
         {
            var call = Async_GetPersonalData(@ids);
            return call.GetValue<@System.@Collections.@Generic.@List<@NFX.@UTest.@Glue.@PersonData>>();
         }

         ///<summary>
         /// Asynchronous invoker for  'NFX.UTest.Glue.ITestContractB.GetPersonalData'.
         /// This is a two-way call per contract specification, meaning - the server sends the result back either
         ///  returning no exception or WrappedExceptionData instance.
         /// CallSlot is returned that can be queried for CallStatus, ResponseMsg and result.
         ///</summary>
         ...
         /// RemoteException is thrown if the server generated exception during method execution.
         ///</summary>
         public @System.@Collections.@Generic.@List<@NFX.@UTest.@Glue.@PersonData> @GetPersonalData(@System.@Int32[]  @ids, @System.@Boolean  @onlyCertified, @System.@Decimal  @maxSalary)
         {
         ...
         ///<summary>
         /// Synchronous invoker for  'NFX.UTest.Glue.ITestContractB.GetDailyStatuses'.
         /// This is a two-way call per contract specification, meaning - the server sends the result back either
         ///  returning '@System.@Collections.@Generic.@Dictionary<@System.@Nullable<@System.@DateTime>, @System.@Collections.@Generic.@List<@NFX.@UTest.@Glue.@PersonData>>' or WrappedExceptionData instance.
         /// ClientCallException is thrown if the call could not be placed in the outgoing queue.
         /// RemoteException is thrown if the server generated exception during method execution.
         ///</summary>
         public @System.@Collections.@Generic.@Dictionary<@System.@Nullable<@System.@DateTime>, @System.@Collections.@Generic.@List<@NFX.@UTest.@Glue.@PersonData>> @GetDailyStatuses(@System.@Int32  @count)
         {
            var call = Async_GetDailyStatuses(@count);
            return call.GetValue<@System.@Collections.@Generic.@Dictionary<@System.@Nullable<@System.@DateTime>, @System.@Collections.@Generic.@List<@NFX.@UTest.@Glue.@PersonData>>>();
         }

         ///<summary>
         /// Asynchronous invoker for  'NFX.UTest.Glue.ITestContractB.GetDailyStatuses'.
         /// This is a two-way call per contract specification, meaning - the server sends the result back either
         ///  returning no exception or WrappedExceptionData instance.
         /// CallSlot is returned that can be queried for CallStatus, ResponseMsg and result.
         ///</summary>
         ...
         ///<summary>
         /// Synchronous invoker for  'NFX.UTest.Glue.ITestContractB.SummarizeAndFinish'.
         /// This is a two-way call per contract specification, meaning - the server sends the result back either
         ///  returning '@System.@String' or WrappedExceptionData instance.
         /// ClientCallException is thrown if the call could not be placed in the outgoing queue.
         /// RemoteException is thrown if the server generated exception during method execution.
         ...
         ///<summary>
         /// Asynchronous invoker for  'NFX.UTest.Glue.ITestContractB.SummarizeAndFinish'.
         /// This is a two-way call per contract specification, meaning - the server sends the result back either
         ///  returning no exception or WrappedExceptionData instance.
         /// CallSlot is returned that can be queried for CallStatus, ResponseMsg and result.
         ///</summary>
