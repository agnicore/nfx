...
");
    ...
    public void TryCreatePart_NullName()
    {
      ...
      {
        Aver.IsTrue(e.Message.Contains(NFX.Web.StringConsts.MULTIPART_PART_EMPTY_NAME_ERROR));
      }
    }
    ...
    public void TryCreateMultipart_NullParts()
    {
      ...
      {
        Aver.IsTrue(e.Message.Contains(NFX.Web.StringConsts.MULTIPART_PARTS_COULDNT_BE_EMPTY_ERROR));
      }
    }
...
");
      ...
      catch (Exception e)
      {
        ...
        Aver.IsTrue(e.Message.Contains(NFX.Web.StringConsts.MULTIPART_PART_COULDNT_BE_EMPTY_ERROR));
      }
    }
...
");
      ...
      {
        Aver.IsTrue(e.Message.Contains(NFX.Web.StringConsts.MULTIPART_PART_MUST_BE_ENDED_WITH_EOL_ERROR));
      }
    }
...
");
      ...
      {
        Aver.IsTrue(e.Message.Contains(NFX.Web.StringConsts.MULTIPART_DOUBLE_EOL_ISNT_FOUND_AFTER_HEADER_ERROR));
      }
    }
...
");
      ...
      {
        Aver.IsTrue(ex.Message.Contains(NFX.Web.StringConsts.MULTIPART_SPECIFIED_BOUNDARY_ISNT_FOUND_ERROR));
      }
    }
...
");
      ...
      {
        Aver.IsTrue(e.Message.Contains(NFX.Web.StringConsts.MULTIPART_BOUNDARY_IS_TOO_SHORT));
      }
    }
...
");
      ...
      {
        Aver.IsTrue(e.Message.Contains(NFX.Web.StringConsts.MULTIPART_BOUNDARY_SHOULD_START_WITH_HYPHENS));
      }
    }
...
");
      ...
      {
        Aver.IsTrue(e.Message.Contains(NFX.Web.StringConsts.MULTIPART_TERMINATOR_ISNT_FOUND_ERROR));
      }
    }
    ...
    private byte[] getEmbeddedFileBytes(string resourceName)
    {
      ...
      using (var stream = NFX.EmbeddedResource.GetBinaryStream(typeof(MultipartTests), resourceFullName))
      {
