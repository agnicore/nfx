       ...
       starter
       {
         ...
         content-file-system
         {
            ...
            root-path=$'c:\'
              ...
              portal
              {
                name='Paris' type='NFX.UTest.Web.MockPortalFrench, NFX.UTest' 
                primary-root-uri='http://paris.for.me'
                default=true

                theme{ name='Eiffel'  default=true  type='NFX.UTest.Web.EuroTheme, NFX.UTest' resource-path='paris'}
              }
              portal
              {
                name='Berlin' type='NFX.UTest.Web.MockPortalGerman, NFX.UTest' 
                primary-root-uri='http://berlin.for.me'

                theme{ name='Merkel'  default=true  type='NFX.UTest.Web.EuroTheme, NFX.UTest' resource-path='ausgang'}
              }
       }//PortalHub
    }
