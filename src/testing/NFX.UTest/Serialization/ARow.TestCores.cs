...
namespace NFX.UTest.Serialization.Arow
{
  ///<summary>
  /// ITypeSerializationCore for NFX.UTest.Serialization.SimplePersonRow
  ///</summary>
  internal class SimplePersonRow_arow_core : NFX.Serialization.Arow.ITypeSerializationCore
  {
    ...
    {
       ArowSerializer.Register(typeof(NFX.UTest.Serialization.SimplePersonRow), this);
    }

    void ITypeSerializationCore.Serialize(TypedRow aRow, WritingStreamer streamer)
    {
      var row = (NFX.UTest.Serialization.SimplePersonRow)aRow;
      // 'id' = 26980
  ...
  ///<summary>
  /// ITypeSerializationCore for NFX.UTest.Serialization.SimplePersonWithEnumRow
  ///</summary>
  internal class SimplePersonWithEnumRow_arow_core : NFX.Serialization.Arow.ITypeSerializationCore
  {
    void ITypeSerializationCore.Register()
    {
       ArowSerializer.Register(typeof(NFX.UTest.Serialization.SimplePersonWithEnumRow), this);
    }

    void ITypeSerializationCore.Serialize(TypedRow aRow, WritingStreamer streamer)
    {
      var row = (NFX.UTest.Serialization.SimplePersonWithEnumRow)aRow;
      // 'id' = 26980
      AW.Write(streamer, 26980, row.ID);
      // 'name' = 1851878757
      if (row.Name != null)
    ...
    void ITypeSerializationCore.Deserialize(TypedRow aRow, ReadingStreamer streamer)
    {
      ...
      while(true)
      {
         ...
         switch(name)
         {
           ...
           var ev = (@NFX.@UTest.@Serialization.@SimplePersonWithEnumRow.@MaritalStatus)Reader.ReadInt32(streamer);
           row.Married = ev;
           continue;
                     }
         }
  ...
  ///<summary>
  /// ITypeSerializationCore for NFX.UTest.Serialization.FamilyRow
  ///</summary>
  internal class FamilyRow_arow_core : NFX.Serialization.Arow.ITypeSerializationCore
  {
    void ITypeSerializationCore.Register()
    {
       ArowSerializer.Register(typeof(NFX.UTest.Serialization.FamilyRow), this);
    }

    void ITypeSerializationCore.Serialize(TypedRow aRow, WritingStreamer streamer)
    {
      var row = (NFX.UTest.Serialization.FamilyRow)aRow;
      // 'id' = 26980
      AW.Write(streamer, 26980, row.ID);
      // 'fam' = 6709613
      if (row.Name != null)
    ...
    void ITypeSerializationCore.Deserialize(TypedRow aRow, ReadingStreamer streamer)
    {
      ...
      while(true)
      {
         ...
         switch(name)
         {
           ...
           var vrow = new NFX.UTest.Serialization.SimplePersonRow();
           ...
           row.Brothers = Reader.ReadRowArray<NFX.UTest.Serialization.SimplePersonRow>(row, streamer, CodeGenerator.GetName(name));
           continue;
                     }
           case 7563635: { // 'sis'
           ...
           atp = Reader.ReadDataType(streamer);
           if (atp!=DataType.Row) break;
           row.Sisters = Reader.ReadRowArray<NFX.UTest.Serialization.SimplePersonRow>(row, streamer, CodeGenerator.GetName(name));
           continue;
                     }
           case 6382710: { // 'adv'
           ...
           atp = Reader.ReadDataType(streamer);
           if (atp!=DataType.Row) break;
           row.Advisers = Reader.ReadRowList<NFX.UTest.Serialization.SimplePersonRow>(row, streamer, CodeGenerator.GetName(name));
           continue;
                     }
         }
         Reader.ConsumeUnmatched(row, streamer, CodeGenerator.GetName(name), dt, atp);
  ...
  ///<summary>
  /// ITypeSerializationCore for NFX.UTest.Serialization.AllArowTypesRow
  ///</summary>
  internal class AllArowTypesRow_arow_core : NFX.Serialization.Arow.ITypeSerializationCore
  {
    void ITypeSerializationCore.Register()
    {
       ArowSerializer.Register(typeof(NFX.UTest.Serialization.AllArowTypesRow), this);
    }

    void ITypeSerializationCore.Serialize(TypedRow aRow, WritingStreamer streamer)
    {
      var row = (NFX.UTest.Serialization.AllArowTypesRow)aRow;
      // 'bool1' = 422776368177
    ...
    void ITypeSerializationCore.Deserialize(TypedRow aRow, ReadingStreamer streamer)
    {
      ...
      while(true)
      {
         ...
         continue;
           ...
           atp = Reader.ReadDataType(streamer);
           if (atp!=DataType.Row) break;
           row.RowArray = Reader.ReadRowArray<NFX.UTest.Serialization.AllArowTypesRow>(row, streamer, CodeGenerator.GetName(name));
           continue;
                     }
           ...
           atp = Reader.ReadDataType(streamer);
           if (atp!=DataType.Row) break;
           row.RowList = Reader.ReadRowList<NFX.UTest.Serialization.AllArowTypesRow>(row, streamer, CodeGenerator.GetName(name));
           continue;
                     }
         }
         Reader.ConsumeUnmatched(row, streamer, CodeGenerator.GetName(name), dt, atp);
  ...
  ///<summary>
  /// ITypeSerializationCore for NFX.UTest.Serialization.Ver1Row
  ///</summary>
  internal class Ver1Row_arow_core : NFX.Serialization.Arow.ITypeSerializationCore
  {
    void ITypeSerializationCore.Register()
    {
       ArowSerializer.Register(typeof(NFX.UTest.Serialization.Ver1Row), this);
    }

    void ITypeSerializationCore.Serialize(TypedRow aRow, WritingStreamer streamer)
    {
      var row = (NFX.UTest.Serialization.Ver1Row)aRow;
      // 'a' = 97
      if (row.A != null)
    ...
    void ITypeSerializationCore.Deserialize(TypedRow aRow, ReadingStreamer streamer)
    {
      ...
      while(true)
      {
         ...
         continue;
           ...
           atp = Reader.ReadDataType(streamer);
           if (atp!=DataType.Row) break;
           row.G = Reader.ReadRowList<NFX.UTest.Serialization.Ver1Row>(row, streamer, CodeGenerator.GetName(name));
           continue;
                     }
         }
         Reader.ConsumeUnmatched(row, streamer, CodeGenerator.GetName(name), dt, atp);
  ...
  ///<summary>
  /// ITypeSerializationCore for NFX.UTest.Serialization.Ver2Row
  ///</summary>
  internal class Ver2Row_arow_core : NFX.Serialization.Arow.ITypeSerializationCore
  {
    void ITypeSerializationCore.Register()
    {
       ArowSerializer.Register(typeof(NFX.UTest.Serialization.Ver2Row), this);
    }

    void ITypeSerializationCore.Serialize(TypedRow aRow, WritingStreamer streamer)
    {
      var row = (NFX.UTest.Serialization.Ver2Row)aRow;
      // 'a' = 97
      if (row.A != null)
      AW.Write(streamer, 97, row.A);
      else AW.WriteNull(streamer, 97);
    ...
    void ITypeSerializationCore.Deserialize(TypedRow aRow, ReadingStreamer streamer)
    {
      ...
      while(true)
      {
         ...
         switch(name)
         {
           ...
           atp = Reader.ReadDataType(streamer);
           if (atp!=DataType.Row) break;
           row.G = Reader.ReadRowList<NFX.UTest.Serialization.Ver2Row>(row, streamer, CodeGenerator.GetName(name));
           continue;
                     }
         }
         Reader.ConsumeUnmatched(row, streamer, CodeGenerator.GetName(name), dt, atp);
