...
namespace NFX.UTest.Config
{
 ...
 <root>
    ...
    <log>
     <behaviors>
       <behavior type='NFX.UTest.Config.AlwaysLogBehavior, NFX.UTest' />
     </behaviors>
...
";
 ...
 <root>
     <behaviors>
       <behavior type='NFX.UTest.Config.AlwaysLogBehavior, NFX.UTest' cascade='true'/>
     </behaviors>
...
static string conf3 = @"
 <root>
     <behaviors>
       <behavior type='NFX.UTest.Config.AlwaysLogBehavior, NFX.UTest' cascade='false'/>
     </behaviors>
...
";
        ...
        [Run]
        [Aver.Throws(typeof(NFXException), Message="No log destinations registered", MsgMatch=Aver.ThrowsAttribute.MatchType.Contains)]
