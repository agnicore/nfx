...
");
        ...
        [Run]
        [Aver.Throws(typeof(ConfigException), Message="which does not exist", MsgMatch=MatchType.Contains)]
...
");
        ...
        [Run]
        [Aver.Throws(typeof(ConfigException), Message="is not after IF", MsgMatch=MatchType.Contains)]
...
");
        ...
        [Run]
        [Aver.Throws(typeof(ConfigException), Message="exceeded allowed timeout", MsgMatch=MatchType.Contains)]
