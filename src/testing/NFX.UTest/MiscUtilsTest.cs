...
";
        ...
        {
            Aver.AreEqual("NFX.UTest.MiscUtilsTest.ClazzA.StructB", typeof(ClazzA.StructB).FullNameWithExpandedGenericArgs(false));
            Aver.AreEqual("@NFX.@UTest.@MiscUtilsTest.@ClazzA.@StructB", typeof(ClazzA.StructB).FullNameWithExpandedGenericArgs(true));

            Aver.AreEqual("NFX.UTest.MiscUtilsTest.ClazzA.ClB", typeof(ClazzA.ClB).FullNameWithExpandedGenericArgs(false));
            Aver.AreEqual("@NFX.@UTest.@MiscUtilsTest.@ClazzA.@ClB", typeof(ClazzA.ClB).FullNameWithExpandedGenericArgs(true));
        }
        ...
        [Run]
        [Aver.Throws(typeof(NFXException), Message = "iso>3", MsgMatch = MatchType.Contains)]
