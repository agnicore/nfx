...
namespace NFX.UTest.Templatization
{
  #warning PAL is required to run the tests
  [Runnable]
  public class TextCSTemplateCompilerTests
  {
    public static readonly string NFX_UTEST_DLL = "NFX.UTest.dll";
    ...
    #region Public
      ...
      public void CompilationProperties()
      {
        const string srcStr = @"#<conf>
          <compiler base-class-name=""NFX.UTest.Templatization.TeztTemplate""
                    namespace=""NFX.UTest.Templatization""
                    abstract=""true""
  ...
  //    {
  //      const string CLASS_NAMESPACE = "NFX.UTest.Templatization";
  //      const string BASE_CLASS_FULLNAME = "NFX.UTest.Templatization.TeztTemplate";
...
#<laconf>
  compiler
  {
     base-class-name=""NFX.UTest.Templatization.TeztTemplate""
