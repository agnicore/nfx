...
published.PuzzleKeypad = function(init) {
  ...
  function rebuild() {
    ...
    function buildPuzzle(root, data) {
      var Ør=arguments[0];if(WAVE.isString(Ør))Ør=WAVE.id(Ør);var Ø1=WAVE.ce('div');var Ø2=WAVE.ce('div');Ø2.setAttribute('id',data.hid);Ø2.setAttribute('class','wvPuzzleHelp');var Ø3=WAVE.ce('div');Ø3.innerText='Protect yourself from fraud!';Ø3.setAttribute('class','wvPuzzleHeader');Ø2.appendChild(Ø3);var Ø4=WAVE.ce('div');Ø4.innerText=data.help;Ø4.setAttribute('class','wvPuzzleBody');Ø2.appendChild(Ø4);Ø1.appendChild(Ø2);var Ø5=WAVE.ce('div');Ø5.innerText=data.question;Ø5.setAttribute('id',data.qid);Ø5.setAttribute('class','wvPuzzleQuestion');Ø1.appendChild(Ø5);var Ø6=WAVE.ce('div');Ø6.setAttribute('class','wvPuzzleImg');var Ø7=WAVE.ce('img');Ø7.setAttribute('id',data.iid);Ø7.setAttribute('src',data.img);Ø6.appendChild(Ø7);Ø1.appendChild(Ø6);var Ø8=WAVE.ce('div');Ø8.setAttribute('class','wvPuzzleControls');var Ø9=WAVE.ce('div');Ø9.setAttribute('class','wvPuzzleInputs');var Ø10=WAVE.ce('div');Ø10.setAttribute('id',data.tid);Ø10.setAttribute('class','wvInput hidden');Ø9.appendChild(Ø10);var Ø11=WAVE.ce('div');Ø11.innerText=data.placeholder;Ø11.setAttribute('id',data.pid);Ø11.setAttribute('class','wvPlaceholder');Ø9.appendChild(Ø11);Ø8.appendChild(Ø9);var Ø12=WAVE.ce('button');Ø12.innerText=data.clear;Ø12.setAttribute('id',data.bid);Ø8.appendChild(Ø12);Ø1.appendChild(Ø8);if(WAVE.isObject(Ør))Ør.appendChild(Ø1);return Ø1;
    }
    ...
    if (fValue.length > 0) {
      for(var i in fValue)
        fdivInput.appendChild((function(){var Ør=arguments[0];if(WAVE.isString(Ør))Ør=WAVE.id(Ør);var Ø1=WAVE.ce('span');Ø1.innerText=args.symbol;if(WAVE.isObject(Ør))Ør.appendChild(Ø1);return Ø1;})());
...
WAVE.RecordModel.GUI = (function () {
    ...
    var published = {
        ...
        function renderTestControl(root, ctx) {
          var Ør=arguments[0];if(WAVE.isString(Ør))Ør=WAVE.id(Ør);var Ø1=WAVE.ce('div');Ø1.setAttribute('div',ctx.about);var Ø2=WAVE.ce('input');Ø2.setAttribute('type','text');Ø2.setAttribute('name',ctx.fName);Ø2.setAttribute('value',ctx.fValue);Ø1.appendChild(Ø2);if(WAVE.isObject(Ør))Ør.appendChild(Ø1);return Ø1;
        }
        ...
        function renderTextBox(root, ctx) {
          var Ør=arguments[0];if(WAVE.isString(Ør))Ør=WAVE.id(Ør);var Ø1=WAVE.ce('div');var Ø2=WAVE.ce('label');Ø2.innerText=ctx.about;Ø2.setAttribute('for',ctx.tbid);Ø2.setAttribute('class',ctx.cls);Ø1.appendChild(Ø2);if(ctx.error){var Ø3=WAVE.ce('div');Ø3.innerText=ctx.error;Ø3.setAttribute('class',ctx.ec);Ø1.appendChild(Ø3);}var Ø4=WAVE.ce('input');Ø4.setAttribute('id',ctx.id);Ø4.setAttribute('type',ctx.tp);Ø4.setAttribute('name',ctx.name);Ø4.disabled=ctx.disabled;Ø4.setAttribute('maxlength',ctx.maxlength);Ø4.readOnly=ctx.readonly;Ø4.setAttribute('value',ctx.value);Ø4.setAttribute('placeholder',ctx.placeholder);Ø4.required=ctx.required;Ø4.__fieldView=ctx.fw;Ø4.addEventListener('change',ctx.handler,false);Ø1.appendChild(Ø4);if(WAVE.isObject(Ør))Ør.appendChild(Ø1);return Ø1;
        }
        ...
        var Ør=arguments[0];if(WAVE.isString(Ør))Ør=WAVE.id(Ør);var Ø1=WAVE.ce('div');var Ø2=WAVE.ce('label');Ø2.innerText=ctx.about;Ø2.setAttribute('for',ctx.tbid);Ø2.setAttribute('class',ctx.cls);Ø1.appendChild(Ø2);if (ctx.error!==null){var Ø3=WAVE.ce('div');Ø3.innerText=ctx.error;Ø3.setAttribute('class',ctx.ec);Ø1.appendChild(Ø3);}var Ø4=WAVE.ce('textarea');Ø4.innerText=ctx.value;Ø4.setAttribute('id',ctx.id);Ø4.setAttribute('name',ctx.name);Ø4.disabled=ctx.disabled;Ø4.setAttribute('maxlength',ctx.maxlength);Ø4.readOnly=ctx.readonly;Ø4.setAttribute('value',ctx.value);Ø4.setAttribute('placeholder',ctx.placeholder);Ø4.required=ctx.required;Ø4.__fieldView=ctx.fw;Ø4.addEventListener('change',ctx.handler,false);Ø1.appendChild(Ø4);if(WAVE.isObject(Ør))Ør.appendChild(Ø1);return Ø1;
        }
        ...
        function renderRadioGroup(root, ctx) {
          var Ør=arguments[0];if(WAVE.isString(Ør))Ør=WAVE.id(Ør);var Ø1=WAVE.ce('fieldset');var Ø2=WAVE.ce('legend');Ø2.innerText=ctx.about;Ø2.setAttribute('class',ctx.cls);Ø1.appendChild(Ø2);if (ctx.error){var Ø3=WAVE.ce('div');Ø3.innerText=ctx.error;Ø3.setAttribute('class',ctx.ec);Ø1.appendChild(Ø3);}for(var i in ctx.keys){ var key = ctx.keys[i], keyDesc = ctx.dict[key], idInput = 'rbt'+ctx.ids+'_'+i;var Ø4=WAVE.ce('input');Ø4.setAttribute('id',idInput);Ø4.setAttribute('name',ctx.name);Ø4.setAttribute('type','radio');Ø4.disabled=ctx.disabled;Ø4.readOnly=ctx.readonly;Ø4.setAttribute('value',key);Ø4.required=ctx.required;Ø4.checked=WAVE.strSame(key, ctx.value) ? 'checked' : '';Ø4.__fieldView=ctx.fw;Ø4.addEventListener('change',ctx.onchange,false);Ø1.appendChild(Ø4);var Ø5=WAVE.ce('label');Ø5.innerText=keyDesc;Ø5.setAttribute('for',idInput);Ø1.appendChild(Ø5);}if(WAVE.isObject(Ør))Ør.appendChild(Ø1);return Ø1;
        }
        ...
        function renderCheck(root, ctx) {
          var Ør=arguments[0];if(WAVE.isString(Ør))Ør=WAVE.id(Ør);var Ø1=WAVE.ce('div');if(ctx.error){var Ø2=WAVE.ce('div');Ø2.innerText=ctx.error;Ø2.setAttribute('class',ctx.ec);Ø1.appendChild(Ø2);}var Ø3=WAVE.ce('input');Ø3.setAttribute('id','h_'+ctx.id);Ø3.setAttribute('type','hidden');Ø3.setAttribute('value',ctx.val);Ø3.setAttribute('name',ctx.name);Ø1.appendChild(Ø3);var Ø4=WAVE.ce('label');Ø4.innerText=ctx.about;Ø4.setAttribute('for',ctx.id);Ø4.setAttribute('class',ctx.cls);Ø1.appendChild(Ø4);var Ø5=WAVE.ce('input');Ø5.setAttribute('id',ctx.id);Ø5.setAttribute('type','checkbox');Ø5.disabled=ctx.disabled;Ø5.readOnly=ctx.readonly;Ø5.required=ctx.required;Ø5.checked=ctx.checked;Ø5.__fieldView=ctx.fw;Ø5.__hiddenId='h_'+ctx.id;Ø5.addEventListener('change',ctx.handler,false);Ø1.appendChild(Ø5);if(WAVE.isObject(Ør))Ør.appendChild(Ø1);return Ø1;
        }
        ...
        function renderComboBox(root, ctx) {
          var Ør=arguments[0];if(WAVE.isString(Ør))Ør=WAVE.id(Ør);var Ø1=WAVE.ce('div');var Ø2=WAVE.ce('label');Ø2.innerText=ctx.about;Ø2.setAttribute('for',ctx.id);Ø2.setAttribute('class',ctx.cls);Ø1.appendChild(Ø2);if (ctx.error){var Ø3=WAVE.ce('div');Ø3.innerText=ctx.error;Ø3.setAttribute('class',ctx.ec);Ø1.appendChild(Ø3);}var Ø4=WAVE.ce('div');Ø4.setAttribute('class',ctx.wrapCls);var Ø5=WAVE.ce('select');Ø5.setAttribute('id',ctx.id);Ø5.setAttribute('name',ctx.name);Ø5.disabled=ctx.disabled;Ø5.readOnly=ctx.readonly;Ø5.setAttribute('value',ctx.value);Ø5.setAttribute('placeholder',ctx.placeholder);Ø5.required=ctx.required;Ø5.__fieldView=ctx.fw;Ø5.addEventListener('change',ctx.handler,false);var Ø6=WAVE.ce('option');Ø6.setAttribute('value','');Ø5.appendChild(Ø6);for(var i in ctx.keys){var val = ctx.keys[i];var Ø7=WAVE.ce('option');Ø7.innerText=ctx.dict[val];Ø7.setAttribute('value',val);Ø7.selected=WAVE.strSame(val, ctx.value) ? 'selected' : '';Ø5.appendChild(Ø7);}Ø4.appendChild(Ø5);var Ø8=WAVE.ce('div');Ø8.setAttribute('id',ctx.arId);Ø8.setAttribute('class',ctx.arCls);Ø4.appendChild(Ø8);Ø1.appendChild(Ø4);if(WAVE.isObject(Ør))Ør.appendChild(Ø1);return Ø1;
        }
        ...
        function renderHidden(root, ctx) {
          var Ør=arguments[0];if(WAVE.isString(Ør))Ør=WAVE.id(Ør);var Ø1=WAVE.ce('input');Ø1.setAttribute('type','hidden');Ø1.setAttribute('name',ctx.name);Ø1.setAttribute('value',ctx.value);if(WAVE.isObject(Ør))Ør.appendChild(Ø1);return Ø1;
        }
        ...
        function renderCustomControlContainer(root, lblDivId, cntDivId) {
          var Ør=arguments[0];if(WAVE.isString(Ør))Ør=WAVE.id(Ør);var Ø1=WAVE.ce('div');var Ø2=WAVE.ce('div');Ø2.setAttribute('id',lblDivId);Ø1.appendChild(Ø2);var Ø3=WAVE.ce('div');Ø3.setAttribute('id',cntDivId);Ø1.appendChild(Ø3);if(WAVE.isObject(Ør))Ør.appendChild(Ø1);return Ø1;
        }

        function renderCustomControlContent(root, ctx) {
          WAVE.removeChildren(root);
          var Ør=arguments[0];if(WAVE.isString(Ør))Ør=WAVE.id(Ør);var Ø1=WAVE.ce('nfx');var Ø2=WAVE.ce('div');Ø2.innerText=ctx.error;Ø2.setAttribute('class',ctx.ec);Ø1.appendChild(Ø2);var Ø3=WAVE.ce('label');Ø3.innerText=ctx.about;Ø3.setAttribute('class',ctx.cls);Ø1.appendChild(Ø3);if(WAVE.isObject(Ør))Ør.appendChild(Ø1);return Ø1;
        }
        ...
        function renderPuzzleContainer(root, ctx) {
          var Ør=arguments[0];if(WAVE.isString(Ør))Ør=WAVE.id(Ør);var Ø1=WAVE.ce('div');var Ø2=WAVE.ce('div');Ø2.innerText=ctx.error;Ø2.setAttribute('class',ctx.ec);Ø1.appendChild(Ø2);var Ø3=WAVE.ce('div');Ø3.setAttribute('id',ctx.id);Ø3.setAttribute('class',ctx.cls);Ø1.appendChild(Ø3);var Ø4=WAVE.ce('input');Ø4.setAttribute('id',ctx.hId);Ø4.setAttribute('type','hidden');Ø4.setAttribute('name',ctx.name);Ø4.setAttribute('value','');Ø1.appendChild(Ø4);if(WAVE.isObject(Ør))Ør.appendChild(Ø1);return Ø1;
        }
        ...
        function renderMDEText(root, ctx) {
          var Ør=arguments[0];if(WAVE.isString(Ør))Ør=WAVE.id(Ør);var Ø1=WAVE.ce('textarea');Ø1.setAttribute('id',ctx.id);Ø1.setAttribute('name',ctx.name);Ø1.addEventListener('change',ctx.handler,false);Ø1.setAttribute('style','width:100%;height:100%;max-width:100%;max-height:100%;');if(WAVE.isObject(Ør))Ør.appendChild(Ø1);return Ø1;
        }
        ...
        function buildMarkdownEditor(fldView) {
          ...
          if (!fldView.__tabs || (ve && !fldView.__ve)) {
            ...
            var label = (function(){var Ør=arguments[0];if(WAVE.isString(Ør))Ør=WAVE.id(Ør);var Ø1=WAVE.ce('label');Ø1.innerText=field.about();Ø1.setAttribute('for',idMDEText);Ø1.setAttribute('class',labelCls);if(WAVE.isObject(Ør))Ør.appendChild(Ø1);return Ø1;})();
            divRoot.appendChild(label);

            if (ve !== null) {
                var error = (function(){var Ør=arguments[0];if(WAVE.isString(Ør))Ør=WAVE.id(Ør);var Ø1=WAVE.ce('div');Ø1.innerText=ve;Ø1.setAttribute('class',published.CLS_ERROR);if(WAVE.isObject(Ør))Ør.appendChild(Ø1);return Ø1;})();
              ...
              tabs: [
                {
                  name: tabMDEText,
                  title: 'Text',
                  content: (function(){var Ør=arguments[0];if(WAVE.isString(Ør))Ør=WAVE.id(Ør);var Ø1=WAVE.ce('div');var Ø2=WAVE.ce('div');Ø2.setAttribute('id',idMDETextContainer);Ø2.setAttribute('style','height:100%;');Ø1.appendChild(Ø2);if(WAVE.isObject(Ør))Ør.appendChild(Ø1);return Ø1;})().innerHTML,
                },
                {
                  name: tabMDEPreview,
                  title: 'Preview',
                  content: (function(){var Ør=arguments[0];if(WAVE.isString(Ør))Ør=WAVE.id(Ør);var Ø1=WAVE.ce('div');var Ø2=WAVE.ce('div');Ø2.setAttribute('id',idMDEPreview);Ø1.appendChild(Ø2);if(WAVE.isObject(Ør))Ør.appendChild(Ø1);return Ø1;})().innerHTML,
                  isHtml: true
                }
              ]
            });
        ...
        function renderErrorRec(root, ctx) {
          var Ør=arguments[0];if(WAVE.isString(Ør))Ør=WAVE.id(Ør);var Ø1=WAVE.ce('div');Ø1.innerText=ctx.error;Ø1.setAttribute('class',ctx.ec);if(WAVE.isObject(Ør))Ør.appendChild(Ø1);return Ø1;
        }
