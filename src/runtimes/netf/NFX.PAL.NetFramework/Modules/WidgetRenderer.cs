...
namespace NFX.PAL.NetFramework.Modules
{
  ...
  public sealed class WidgetRenderer : ModuleBase, IPuzzleKeypadRenderer
  {
    ...
    NFX.Graphics.Image IPuzzleKeypadRenderer.RenderDefaultPuzzleKeypad(PuzzleKeypad keypad, Color? bgColor, bool showRects)
    {
      var gdiImage = drawGDIPuzzleKeypadImage(keypad, bgColor, showRects);
      var handle = new Graphics.NetImage(gdiImage);
      var img = new NFX.Graphics.Image( handle );
